import{r as s,j as e,b as o}from"./index-BxXbnW9e.js";import{C as i}from"./Cardruntime-DF2YgfxL.js";import{A as u}from"./index-LK1iCBIb.js";import"./index-BEsnAH_r.js";import"./activecode-BfSkJlGQ.js";import"./index-DMQVh9lL.js";import"./Preview-Cfw1m546.js";const a=`import {useState} from 'react'
...
`;function m(){var[n,t]=s.useState(0);function c(){t(n+1)}return e.jsxs("div",{children:[e.jsx("div",{children:"A Expensive Case"}),e.jsxs("div",{className:"flex items-center justify-between mt-4",children:[e.jsxs("div",{className:"counter",children:["current counter is: ",n]}),e.jsx("button",{onClick:c,children:"counter++"})]}),e.jsx(p,{})]})}function p(){for(var n=performance.now();performance.now()-n<100;);return e.jsx("div",{className:"border border-red-500 rounded p-4 mt-4 text-red-500 text-sm leading-6",children:"这是模拟的一个耗时子组件，我的渲染至少要损耗 100ms 的时间，因此如果不做任何优化的情况下，当你快速点击按钮时，你会感受到 counter 的递增会有明显的掉帧。"})}function r(n){const t={code:"code",p:"p",pre:"pre",strong:"strong",...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i,{children:e.jsx(m,{})}),`
...
`})}),`
`,e.jsxs(t.p,{children:["因此，编译优化之后，我们能够非常明显的感受到",e.jsx(t.strong,{children:"掉帧的现象"}),"消失了。在优化之前，由于 counter 导致组件 re-render，所以该子组件虽然没有任何参数传递进去，但是依然不可避免的需要重新执行，从而导致每次更新的耗时都非常大。"]})]})}function x(n={}){const{wrapper:t}=n.components||{};return t?e.jsx(t,{...n,children:e.jsx(r,{...n})}):r(n)}const f={"App.js":a,原代码:l,"useCache.js":{code:d,hidden:!0},"Button.jsx":{code:o,hidden:!0}};function k(){return e.jsx(u,{files:f,renderArticle:n=>e.jsx(x,{components:{code:n}})})}export{k as default};
