import{c as d,r as m,j as t}from"./index-oFmtIK6i.js";import{B as f}from"./index-BmRxIqvy.js";import{C as j}from"./Cardruntime-CDREzpNb.js";import{A as p}from"./index-joL20ffn.js";import"./index-DiYRcp-t.js";import"./index-DMQVh9lL.js";import"./Preview-D7Xnvlpj.js";import"./atom-one-light-q7r8Raww.js";const x=`import {useState} from 'react'
...
`]}),`
`,t.jsx(e.p,{children:"当然，这里多执行的逻辑也并不是很多，我们也可以选择无视。"})]})}function v(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(u,{...n})}):u(n)}const C={"App.js":x,原代码:h,"useCache.js":{code:_,hidden:!0},"Button.jsx":{code:f,hidden:!0}};function w(){const n=d.c(1);let e;return n[0]===Symbol.for("react.memo_cache_sentinel")?(e=t.jsx(p,{files:C,renderArticle:l=>t.jsx(v,{components:{code:l}})}),n[0]=e):e=n[0],e}export{w as default};
