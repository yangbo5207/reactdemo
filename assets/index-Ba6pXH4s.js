import{r,j as e,M as a,D as i}from"./index-BxXbnW9e.js";import{C as o}from"./Cardruntime-DF2YgfxL.js";import{A as c}from"./index-LK1iCBIb.js";import"./index-BEsnAH_r.js";import"./activecode-BfSkJlGQ.js";import"./index-DMQVh9lL.js";import"./Preview-Cfw1m546.js";const d=`import { useRef } from 'react'
...
`,u=`import { useEffect, useRef, useState, useImperativeHandle } from 'react';
...
`,f=`import { useState, useImperativeHandle} from "react";
...
`;function m(){const s=r.useRef(null);return e.jsxs("div",{className:"flex justify-between",children:[e.jsx("button",{onClick:()=>s.current.show(),className:"ml-3",children:"点击弹窗显示"}),e.jsx(a,{ref:s,children:e.jsx("div",{className:"bg-white p-4 max-w-xl mt-48 mx-auto rounded",children:"这是一个小弹窗"})})]})}function t(){const s=r.useRef(null);return e.jsxs("div",{className:"flex justify-between",children:[e.jsx("button",{onClick:()=>s.current.show(),className:"ml-3",children:"点击我，显示对话框组件"}),e.jsxs(i,{ref:s,title:"Message For You",onSure:()=>s.current.close(),children:[e.jsx("strong",{className:"text-red-500",children:"React 19"})," 是全网学习体验最好的小册，没有之一。它能帮助你快速领悟到 React 的独特的开发魅力，你将会感受到更快的学习速度，更高效的开发速度，更专业的开发思维。",e.jsx("div",{className:"mt-4",children:e.jsx("img",{src:"https://images.unsplash.com/photo-1485856407642-7f9ba0268b51?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",alt:""})})]})]})}function l(s){const n={code:"code",em:"em",h2:"h2",p:"p",pre:"pre",strong:"strong",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{children:e.jsx(t,{})}),`
...
`,e.jsxs(n.p,{children:["最终的代码请看右侧案例中的 ",e.jsx(n.code,{children:"Dialog.jsx"})]})]})}function p(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(l,{...s})}):l(s)}const h={"App.js":d,"Dialog.jsx":u,"Modal.jsx":f};function D(){return e.jsx(c,{files:h,hidePreview:!0,renderArticle:s=>e.jsx(p,{components:{code:s}})})}export{D as default};
