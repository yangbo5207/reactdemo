import{c as d,j as s,r as m,t as w,a as k,G as N,b as S,d as _,e as R,f as M}from"./index-Di4F1x74.js";import{g as H,h as C,a as L}from"./atom-one-light-C8MDVoqG.js";import{P as T}from"./Preview-BBadGkLg.js";import{C as f}from"./Cardruntime-Cp1f-EP2.js";const P=`import React, { useEffect, useState, Suspense, use } from 'react';
...
`,E=`export default function Skeleton(props) {
  return (
...
`,v=n=>{const e=d.c(4),o=n.message;let t;e[0]===Symbol.for("react.memo_cache_sentinel")?(t=s.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"size-6 mt-2",children:s.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 0 0 6.16-12.12A14.98 14.98 0 0 0 9.631 8.41m5.96 5.96a14.926 14.926 0 0 1-5.841 2.58m-.119-8.54a6 6 0 0 0-7.381 5.84h4.8m2.581-5.84a14.927 14.927 0 0 0-2.58 5.84m2.699 2.7c-.103.021-.207.041-.311.06a15.09 15.09 0 0 1-2.448-2.448 14.9 14.9 0 0 1 .06-.312m-2.24 2.39a4.493 4.493 0 0 0-1.757 4.306 4.493 4.493 0 0 0 4.306-1.758M16.5 9a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0Z"})}),e[0]=t):t=e[0];let a;e[1]===Symbol.for("react.memo_cache_sentinel")?(a=s.jsx("div",{children:"Heads Up!"}),e[1]=a):a=e[1];let r;return e[2]!==o?(r=s.jsxs("div",{className:"flex border border-blue-100 p-4 rounded-md shadow",children:[t,s.jsxs("div",{className:"flex-1 ml-3",children:[a,s.jsx("div",{className:"text-sm mt-1 text-gray-600",children:o})]})]}),e[2]=o,e[3]=r):r=e[3],r},A=new Promise(n=>{n({value:"Unlike React Hooks, use can be called within loops and conditional statements like if. Like React Hooks, the function that calls use must be a Component or Hook."})});function $(){const n=d.c(2),e=m.use(A);let o;return n[0]!==e.value?(o=s.jsx(v,{message:e.value}),n[0]=e.value,n[1]=o):o=n[1],o}document.documentElement.style.fontSize="14px";function z(n){const e=d.c(24);let o,t,a,r,l,i,c,u;e[0]!==n?({className:c,primary:o,danger:t,sm:l,lg:i,signal:r,success:a,...u}=n,e[0]=n,e[1]=o,e[2]=t,e[3]=a,e[4]=r,e[5]=l,e[6]=i,e[7]=c,e[8]=u):(o=e[1],t=e[2],a=e[3],r=e[4],l=e[5],i=e[6],c=e[7],u=e[8]);let h;e[9]!==o||e[10]!==t||e[11]!==a||e[12]!==r||e[13]!==l||e[14]!==i||e[15]!==c?(h=w(k("rounded-md border border-transparent font-medium cursor-pointer transition relative","bg-gray-100 hover:bg-gray-200","text-xs py-2 px-4",{"bg-blue-500 text-white hover:bg-blue-600":o,"bg-red-500 text-white hover:bg-red-600":t,"bg-green-500 text-white hover:bg-green-600":a,"text-sky-500 bg-white border border-sky-300 hover:bg-sky-50":r,"text-xs py-1.5 px-3":l,"text-lg py-2 px-6":i},c)),e[9]=o,e[10]=t,e[11]=a,e[12]=r,e[13]=l,e[14]=i,e[15]=c,e[16]=h):h=e[16];const g=h;let p;e[17]!==r?(p=r&&s.jsxs("span",{className:"absolute flex h-3 w-3 right-[-5px] top-[-5px]",children:[s.jsx("span",{className:"animate-ping absolute inline-flex h-full w-full rounded-full bg-sky-400 opacity-75"}),s.jsx("span",{className:"relative inline-flex rounded-full h-3 w-3 bg-sky-500"})]}),e[17]=r,e[18]=p):p=e[18];let x;return e[19]!==g||e[20]!==u||e[21]!==n.children||e[22]!==p?(x=s.jsxs("button",{className:g,...u,children:[n.children,p]}),e[19]=g,e[20]=u,e[21]=n.children,e[22]=p,e[23]=x):x=e[23],x}function j(n){const e=d.c(3);let o;e[0]===Symbol.for("react.memo_cache_sentinel")?(o=s.jsx("div",{className:"rounded-full bg-slate-200 h-10 w-10"}),e[0]=o):o=e[0];let t;e[1]===Symbol.for("react.memo_cache_sentinel")?(t=s.jsx("div",{className:"h-2 bg-slate-200 rounded"}),e[1]=t):t=e[1];let a;return e[2]===Symbol.for("react.memo_cache_sentinel")?(a=s.jsx("div",{className:"border border-blue-100 shadow rounded-md p-4 w-full",children:s.jsxs("div",{className:"animate-pulse flex space-x-4",children:[o,s.jsxs("div",{className:"flex-1 space-y-6 py-1",children:[t,s.jsxs("div",{className:"space-y-3",children:[s.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[s.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-2"}),s.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-1"})]}),s.jsx("div",{className:"h-2 bg-slate-200 rounded"})]})]})]})}),e[2]=a):a=e[2],a}const O=new Promise(n=>{n({value:"Unlike React Hooks, use can be called within loops and conditional statements like if. Like React Hooks, the function that calls use must be a Component or Hook."})});function I(){const n=d.c(9),[e,o]=m.useState(!1);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t={value:""},n[0]=t):t=n[0];let a=t;e||(a=m.use(O));let r;n[1]!==e||n[2]!==a?(r=e?s.jsx(j,{}):s.jsx(v,{message:a.value}),n[1]=e,n[2]=a,n[3]=r):r=n[3];let l;n[4]!==e?(l=s.jsx("div",{className:"mt-4 text-right",children:s.jsx(z,{signal:!0,onClick:()=>o(!e),children:"切换"})}),n[4]=e,n[5]=l):l=n[5];let i;return n[6]!==r||n[7]!==l?(i=s.jsxs(s.Fragment,{children:[r,l]}),n[6]=r,n[7]=l,n[8]=i):i=n[8],i}const q=["React lets you build user interfaces out of individual pieces called components. Create your own React components like Thumbnail, LikeButton, and Video. Then combine them into entire screens, pages, and apps.","Whether you work on your own or with thousands of other developers, using React feels the same.","React components are JavaScript functions. Want to show some content conditionally? Use an if statement. Displaying a list? Try array map(). Learning React is learning programming.","This markup syntax is called JSX. It is a JavaScript syntax extension popularized by React. ","You don’t have to build your whole page in React. Add React to your existing HTML page, and render interactive React components anywhere on it."];var y=new Headers;y.append("User-Agent","Apifox/1.0.0 (https://apifox.com)");var G={method:"GET",headers:y,redirect:"follow",data:"hex"};const J="https://echo.apifox.com/delay/1",W=async()=>{await fetch(J,G);const n=Math.floor(Math.random()*10)%5;return{value:q[n]}};function F(){const n=d.c(5),[e]=m.useState(!0);let o;n[0]===Symbol.for("react.memo_cache_sentinel")?(o=s.jsx("div",{}),n[0]=o):o=n[0];let t;n[1]!==e?(t=e?s.jsx(X,{}):s.jsx(j,{}),n[1]=e,n[2]=t):t=n[2];let a;return n[3]!==t?(a=s.jsx(m.Suspense,{fallback:o,children:s.jsx("div",{children:t})}),n[3]=t,n[4]=a):a=n[4],a}function X(){const n=d.c(5),[e,o]=m.useState(!0);let t;n[0]===Symbol.for("react.memo_cache_sentinel")?(t=W().then(c=>(o(!1),c)),n[0]=t):t=n[0];const a=t;let r;n[1]===Symbol.for("react.memo_cache_sentinel")?(r={value:"",icon_url:""},n[1]=r):r=n[1];let l=r;e||(l=m.use(a));let i;return n[2]!==e||n[3]!==l?(i=e?s.jsx(j,{}):s.jsx(v,{message:l.value}),n[2]=e,n[3]=l,n[4]=i):i=n[4],i}function b(n){const e={blockquote:"blockquote",code:"code",em:"em",h2:"h2",p:"p",pre:"pre",strong:"strong",...n.components};return s.jsxs(s.Fragment,{children:[s.jsxs(e.p,{children:[s.jsx(e.code,{children:"use()"})," 是 React19 提升异步开发体验最重要的 hook。也是让 useEffect 重要性大幅度削弱的主要原因。"]}),`
...
`})}),`
`,s.jsx(f,{reload:!0,children:s.jsx(F,{})}),`
...
`,s.jsx(e.p,{children:"因此，在实践中，如果我们要读取异步请求的 promise 中的值，必须结合 Suspense 来处理。在右侧的案例中，我们列举了一个 use + Suspense 合理处理异步请求的案例，大家可以先暂时了解一下，在后续的章节中，我们详细学习了 Suspense 之后再来进行案例分析。"})]})}function Y(n={}){const{wrapper:e}=n.components||{};return e?s.jsx(e,{...n,children:s.jsx(b,{...n})}):b(n)}const V={"App.js":P,"api.js":D,"Button.jsx":B,"Skeleton.jsx":E,"/public/index.html":{code:U,hidden:!0}};function Z({className:n,...e}){const o=/language-(\w+)/.exec(n||"");return o?s.jsx(C,{language:o[1],PreTag:"div",...e,style:L}):s.jsx("code",{className:n,...e})}function ne(){const n=d.c(7);let e,o;n[0]===Symbol.for("react.memo_cache_sentinel")?(e=s.jsx(Y,{components:{code:Z}}),o=s.jsx("div",{className:"border-b mt-20 mb-8 text-lg font-bold pb-3"}),n[0]=e,n[1]=o):(e=n[0],o=n[1]);let t;n[2]===Symbol.for("react.memo_cache_sentinel")?(t=s.jsxs("div",{className:"md:w-[40%] pr-4 keep",children:[e,o,s.jsx(N,{repo:"yangbo5207/react19feature",repoId:"R_kgDOMGiHOw",category:"General",categoryId:"DIC_kwDOMGiHO84Cf8dR",maping:"pathname",term:"\\u6B22\\u8FCE\\u9053\\u53CB",strict:"0",reactionsEnabled:"1",emitMetadata:"1",inputPosition:"top",lang:"zh-CN",crossorigin:"anonymous",async:!0})]}),n[2]=t):t=n[2];let a,r;n[3]===Symbol.for("react.memo_cache_sentinel")?(a={externalResources:["https://cdn.tailwindcss.com"],editorHeight:"auto"},r={dependencies:{react:"19.0.0-rc-dfd30974ab-20240613","react-dom":"19.0.0-rc-dfd30974ab-20240613","tailwind-merge":"latest",clsx:"latest"}},n[3]=a,n[4]=r):(a=n[3],r=n[4]);let l;n[5]===Symbol.for("react.memo_cache_sentinel")?(l=s.jsx(S,{}),n[5]=l):l=n[5];let i;return n[6]===Symbol.for("react.memo_cache_sentinel")?(i=s.jsx("div",{children:s.jsxs("div",{className:"mt-5 md:flex",children:[t,s.jsx("div",{className:"md:w-[60%] sticky top-[8rem] h-[calc(100vh_-_8rem-35px)] overflow-y-auto",children:s.jsx(_,{template:"react",theme:H,options:a,customSetup:r,files:V,children:s.jsxs(R,{children:[l,s.jsx(T,{children:s.jsx(M,{})})]})})})]})}),n[6]=i):i=n[6],i}export{ne as default};
