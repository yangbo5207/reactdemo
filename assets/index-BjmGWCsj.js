import{c as x,r as j,j as e}from"./index-WxVCoI3R.js";import{B as p}from"./index-BmRxIqvy.js";import{C as u}from"./Cardruntime-CkAYSVvf.js";import{A as h}from"./index-z4EEj1-x.js";import"./activecode-B_nYYbD8.js";import"./index-DMQVh9lL.js";import"./Preview-B0JUZwug.js";import"./atom-one-light-CeVHWIu6.js";const m=`import {useState} from 'react'
...
`]})]})}function g(c={}){const{wrapper:n}=c.components||{};return n?e.jsx(n,{...c,children:e.jsx(a,{...c})}):a(c)}const b={"App.js":m,原代码:f,"useCache.js":{code:$,hidden:!0},"Button.jsx":{code:p,hidden:!0}};function A(){const c=x.c(1);let n;return c[0]===Symbol.for("react.memo_cache_sentinel")?(n=e.jsx(h,{files:b,renderArticle:o=>e.jsx(g,{components:{code:o}})}),c[0]=n):n=c[0],n}export{A as default};
