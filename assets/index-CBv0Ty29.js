import{c as a,r as p,j as n}from"./index-Di4F1x74.js";import{C as m}from"./Cardruntime-Cp1f-EP2.js";import{A as u}from"./index-DrkOu_iN.js";import"./Preview-BBadGkLg.js";import"./atom-one-light-C8MDVoqG.js";const x=`import {Suspense, useState, useTransition} from 'react'
...
`,v=s=>{const e=a.c(5),{isPending:r,response:t}=s,o=p.use(t),l=r?.5:1;let c;e[0]!==l?(c={opacity:l},e[0]=l,e[1]=c):c=e[1];let i;return e[2]!==c||e[3]!==o.value?(i=n.jsx("div",{className:"text-sm leading-6 transition border border-blue-100 shadow rounded-md p-4 w-full mt-4",style:c,children:o.value}),e[2]=c,e[3]=o.value,e[4]=i):i=e[4],i};document.documentElement.style.fontSize="14px";function R(s){const e=a.c(2);let r;e[0]===Symbol.for("react.memo_cache_sentinel")?(r=n.jsx("div",{className:"h-2 bg-slate-200 rounded"}),e[0]=r):r=e[0];let t;return e[1]===Symbol.for("react.memo_cache_sentinel")?(t=n.jsx("div",{className:"border border-blue-100 shadow rounded-md p-4 w-full mt-4",children:n.jsx("div",{className:"animate-pulse",children:n.jsxs("div",{className:"flex-1 space-y-3 py-1",children:[r,n.jsxs("div",{className:"space-y-3",children:[n.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-2"}),n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-1"})]}),n.jsx("div",{className:"h-2 bg-slate-200 rounded"})]})]})})}),e[1]=t):t=e[1],t}const w=["React lets you build user interfaces out of individual pieces called components. Create your own React components like Thumbnail, LikeButton, and Video. Then combine them into entire screens, pages, and apps.","Whether you work on your own or with thousands of other developers, using React feels the same.","React components are JavaScript functions. Want to show some content conditionally? Use an if statement. Displaying a list? Try array map(). Learning React is learning programming.","This markup syntax is called JSX. It is a JavaScript syntax extension popularized by React. ","You don’t have to build your whole page in React. Add React to your existing HTML page, and render interactive React components anywhere on it."];var h=new Headers;h.append("User-Agent","Apifox/1.0.0 (https://apifox.com)");var k={method:"GET",headers:h,redirect:"follow",data:"hex"};const S="https://echo.apifox.com/delay/1",N=async()=>{await fetch(S,k);const s=Math.floor(Math.random()*10)%5;return{value:w[s]}};function M(){const s=a.c(3);let e;s[0]===Symbol.for("react.memo_cache_sentinel")?(e=N(),s[0]=e):e=s[0];const r=e;let t;s[1]===Symbol.for("react.memo_cache_sentinel")?(t=n.jsx(R,{}),s[1]=t):t=s[1];let o;return s[2]===Symbol.for("react.memo_cache_sentinel")?(o=n.jsx(p.Suspense,{fallback:t,children:n.jsx(v,{response:r})}),s[2]=o):o=s[2],o}function d(s){const e={a:"a",blockquote:"blockquote",code:"code",em:"em",h2:"h2",p:"p",pre:"pre",strong:"strong",...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:n.jsx(e.em,{children:"0"})}),`
...
`,n.jsx(m,{reload:!0,children:n.jsx(M,{})}),`
...
`,n.jsx(e.p,{children:"希望大家能够在这里获得全网最好的学习体验！Let's go."})]})}function A(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(d,{...s})}):d(s)}const C={"App.js":x,"api.js":j,"Message.jsx":g,"Skeleton.jsx":f,"Button.jsx":b,"/public/index.html":{code:y,hidden:!0}};function B(){const s=a.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(u,{files:C,renderArticle:r=>n.jsx(A,{components:{code:r}})}),s[0]=e):e=s[0],e}export{B as default};
