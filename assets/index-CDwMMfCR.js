import{c as d,j as s,r as u,t as w,a as k}from"./index-CChRFWmF.js";import{C as f}from"./Cardruntime-DUSy2C1S.js";import{A as N}from"./index-CJl_FuZi.js";import"./index-BgxcxkDL.js";import"./atom-one-light-CiE-g8ab.js";import"./Preview-DUFWuue_.js";const S=`import React, { useEffect, useState, Suspense, use } from 'react';
...
`,s.jsx(e.p,{children:"因此，在实践中，如果我们要读取异步请求的 promise 中的值，必须结合 Suspense 来处理。在右侧的案例中，我们列举了一个 use + Suspense 合理处理异步请求的案例，大家可以先暂时了解一下，在后续的章节中，我们详细学习了 Suspense 之后再来进行案例分析。"})]})}function z(n={}){const{wrapper:e}=n.components||{};return e?s.jsx(e,{...n,children:s.jsx(b,{...n})}):b(n)}const q={"App.js":S,"api.js":R,"Button.jsx":_,"Skeleton.jsx":M};function G(){const n=d.c(1);let e;return n[0]===Symbol.for("react.memo_cache_sentinel")?(e=s.jsx(N,{files:q,renderArticle:o=>s.jsx(z,{components:{code:o}})}),n[0]=e):e=n[0],e}export{G as default};
