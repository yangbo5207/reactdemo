import{c as u,j as n,r as m}from"./index-oQiJtYgt.js";import{C as g}from"./Cardruntime-WygvHClN.js";import{A as v}from"./index-FLqTg1MW.js";import"./Preview-CBmvf_l4.js";import"./atom-one-light-EzjejzeC.js";const j=`import {useState, Suspense, useCallback} from 'react'
...
`})}),`
`,n.jsx(e.p,{children:"完整代码与案例演示查看右侧区域。"})]})}function E(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(x,{...s})}):x(s)}const A={"App.js":j,"api.js":N,"List.jsx":y,"Tabs.jsx":C,"Skeleton.jsx":S};function D(){const s=u.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(v,{files:A,renderArticle:a=>n.jsx(E,{components:{code:a}})}),s[0]=e):e=s[0],e}export{D as default};
