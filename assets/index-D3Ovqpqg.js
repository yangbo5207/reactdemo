import{r as s,j as n,c as u,t as a,B as m,b as p}from"./index-BxXbnW9e.js";import{C as c}from"./Cardruntime-DF2YgfxL.js";import{A as f}from"./index-LK1iCBIb.js";import"./index-BEsnAH_r.js";import"./activecode-BfSkJlGQ.js";import"./index-DMQVh9lL.js";import"./Preview-Cfw1m546.js";const x=`import { useRef } from 'react';
...
`,j=`import { useRef, useImperativeHandle } from 'react';
...
`;function g(){const r=s.useRef(null);return n.jsxs("div",{className:"flex justify-between",children:[n.jsx("input",{ref:r,type:"text",className:"border p-2 rounded-md flex-1"}),n.jsx("button",{onClick:()=>r.current.focus(),className:"ml-3",children:"点击获取焦"})]})}function i(r){const{ref:e,className:o,...t}=r,d=u("flex items-center border px-2 rounded-md text-gray-500",o);return n.jsxs("div",{className:a(d),children:[n.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"size-5",children:n.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"})}),n.jsx("input",{ref:e,className:"flex-1 !border-none p-2",style:{outline:"none"},type:"text",...t})]})}function R(){const r=s.useRef(null);return n.jsxs("div",{className:"flex justify-between",children:[n.jsx(i,{ref:r,type:"text",className:"flex-1"}),n.jsx("button",{onClick:()=>r.current.focus(),className:"ml-3",children:"点击获取焦"})]})}function C(){const r=s.useRef(null);function e(){r.current.scrollAndFocusAddComment()}return n.jsxs(n.Fragment,{children:[n.jsx(m,{onClick:e,primary:!0,children:"Write a comment"}),n.jsx(v,{ref:r})]})}const v=({ref:r})=>{const e=s.useRef(null),o=s.useRef(null);return s.useImperativeHandle(r,()=>({scrollAndFocusAddComment(){e.current.scrollToBottom(),o.current.focus()}}),[]),n.jsxs(n.Fragment,{children:[n.jsx("article",{children:n.jsx("p",{children:"Welcome to my Blog!"})}),n.jsx(b,{ref:e}),n.jsx(N,{ref:o})]})},b=({ref:r})=>{const e=s.useRef(null);s.useImperativeHandle(r,()=>({scrollToBottom(){const t=e.current;t.scrollTop=t.scrollHeight}}),[]);let o=[];for(let t=0;t<50;t++)o.push(n.jsxs("p",{children:["Comment #",t]},t));return n.jsx("div",{className:"border p-4 rounded h-32 overflow-y-auto",ref:e,children:o})};function N(r){return n.jsx(i,{placeholder:"Add comment...",ref:r.ref,className:"mt-4"})}function l(r){const e={blockquote:"blockquote",code:"code",em:"em",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:n.jsx(e.em,{children:"1"})}),`
...
`})}),`
`,n.jsx(c,{reload:!0,children:n.jsx(g,{})}),`
...
`})}),`
`,n.jsx(c,{reload:!0,children:n.jsx(R,{})}),`
...
`,n.jsx(c,{reload:!0,children:n.jsx(C,{})})]})}function I(r={}){const{wrapper:e}=r.components||{};return e?n.jsx(e,{...r,children:n.jsx(l,{...r})}):l(r)}const w={"App.js":x,"Post.jsx":j,"Button.jsx":p,"Input.jsx":h};function W(){return n.jsx(f,{files:w,renderArticle:r=>n.jsx(I,{components:{code:r}})})}export{W as default};
