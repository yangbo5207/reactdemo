import{r as p,c as u,j as n,D as P}from"./index-vB-mHLnv.js";import{C as N}from"./Cardruntime-DFtXWoxO.js";import{A as _}from"./index-CLBIbT-Y.js";import"./index-D8xVh8ID.js";import"./atom-one-light-Bb5l2Lva.js";import"./Preview-CBazhn3Q.js";const S=`import Provider from './context'
...
`,A={task:"TASK-8878",content:"Try to calculate the EXE feed, maybe it will index the multi-byte pixel!",status:"Progress",priority:"Medium"},k=p.createContext({});function D(t){const e=u.c(5),{children:s}=t,[c,r]=p.useState(A);let o;e[0]!==c?(o={task:c,updateTask:r},e[0]=c,e[1]=o):o=e[1];let l;return e[2]!==o||e[3]!==s?(l=n.jsx(k,{value:o,children:s}),e[2]=o,e[3]=s,e[4]=l):l=e[4],l}function q(t){const e=u.c(29);let s,c;e[0]!==t?({ref:s,...c}=t,e[0]=t,e[1]=s,e[2]=c):(s=e[1],c=e[2]);const{task:r,updateTask:o}=p.use(k);let l;e[3]!==o||e[4]!==r?(l=function(T){o({...r,content:T.target.value})},e[3]=o,e[4]=r,e[5]=l):l=e[5];const a=l;let i;e[6]!==s.current?(i=()=>s.current.close(),e[6]=s.current,e[7]=i):i=e[7];let j;e[8]===Symbol.for("react.memo_cache_sentinel")?(j=n.jsx("div",{className:"w-20",children:"name"}),e[8]=j):j=e[8];let d;e[9]!==r.task?(d=n.jsxs("div",{className:"flex items-center",children:[j,n.jsx("div",{className:"flex-1 p-2 text-sm font-bold",children:r.task})]}),e[9]=r.task,e[10]=d):d=e[10];let f;e[11]===Symbol.for("react.memo_cache_sentinel")?(f=n.jsx("div",{className:"w-20",children:"content"}),e[11]=f):f=e[11];let x;e[12]!==r.content||e[13]!==a?(x=n.jsxs("div",{className:"flex items-center mt-4",children:[f,n.jsx("input",{value:r.content,className:"flex-1 border rounded-md p-2 text-sm",onChange:a})]}),e[12]=r.content,e[13]=a,e[14]=x):x=e[14];let v;e[15]===Symbol.for("react.memo_cache_sentinel")?(v=n.jsx("div",{className:"w-20",children:"status"}),e[15]=v):v=e[15];let m;e[16]!==r.status?(m=n.jsxs("div",{className:"flex items-center mt-4",children:[v,n.jsx("div",{className:"flex-1 p-2 text-sm text-green-500",children:r.status})]}),e[16]=r.status,e[17]=m):m=e[17];let g;e[18]===Symbol.for("react.memo_cache_sentinel")?(g=n.jsx("div",{className:"w-20",children:"Priority"}),e[18]=g):g=e[18];let h;e[19]!==r.priority?(h=n.jsxs("div",{className:"flex items-center mt-4",children:[g,n.jsx("div",{className:"flex-1 p-2 text-sm text-red-500",children:r.priority})]}),e[19]=r.priority,e[20]=h):h=e[20];let C;return e[21]!==s||e[22]!==c||e[23]!==i||e[24]!==d||e[25]!==x||e[26]!==m||e[27]!==h?(C=n.jsxs(P,{ref:s,...c,onSure:i,children:[d,x,m,h]}),e[21]=s,e[22]=c,e[23]=i,e[24]=d,e[25]=x,e[26]=m,e[27]=h,e[28]=C):C=e[28],C}function M(){const t=u.c(15),e=p.useRef(null),{task:s}=p.use(k);let c;t[0]!==s.task?(c=n.jsx("div",{className:"font-bold",children:s.task}),t[0]=s.task,t[1]=c):c=t[1];let r;t[2]!==s.content?(r=n.jsx("div",{className:"flex-1 mx-3 line-clamp-1",children:s.content}),t[2]=s.content,t[3]=r):r=t[3];let o;t[4]!==s.status?(o=n.jsx("div",{className:"text-green-500",children:s.status}),t[4]=s.status,t[5]=o):o=t[5];let l;t[6]===Symbol.for("react.memo_cache_sentinel")?(l=n.jsx("button",{onClick:()=>e.current.show(),className:"ml-3",children:"edit"}),t[6]=l):l=t[6];let a;t[7]!==e?(a=n.jsx(q,{ref:e,title:"Editor"}),t[7]=e,t[8]=a):a=t[8];let i;return t[9]!==c||t[10]!==r||t[11]!==o||t[12]!==l||t[13]!==a?(i=n.jsxs("div",{className:"flex items-center border-t pt-4",children:[c,r,o,l,a]}),t[9]=c,t[10]=r,t[11]=o,t[12]=l,t[13]=a,t[14]=i):i=t[14],i}function y(){const t=u.c(3);let e,s;t[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx("h3",{className:"font-bold",children:"Your Task"}),s=n.jsx("p",{className:"!text-gray-400",children:"Here's a task for you!"}),t[0]=e,t[1]=s):(e=t[0],s=t[1]);let c;return t[2]===Symbol.for("react.memo_cache_sentinel")?(c=n.jsxs(D,{children:[e,s,n.jsx(M,{})]}),t[2]=c):c=t[2],c}function b(t){const e={blockquote:"blockquote",code:"code",em:"em",h2:"h2",img:"img",p:"p",pre:"pre",strong:"strong",...t.components};return n.jsxs(n.Fragment,{children:[n.jsx(N,{children:n.jsx(y,{})}),`
...
`})}),`
`,n.jsxs(e.p,{children:["然后再各子组件中，使用 ",n.jsx(e.code,{children:"use(Context)"})," 获取当前组件需要的数据和方法即可"]}),`
...
`,n.jsxs(e.p,{children:["这里比较有意思的一个地方是在 ",n.jsx(e.code,{children:"editor.jsx"})," 文件中，对于 ref 的使用和处理，大家可以留心观察一下。"]})]})}function $(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(b,{...t})}):b(t)}const F={"App.js":S,"context.jsx":E,"task.jsx":R,"editor.jsx":w};function L(){const t=u.c(1);let e;return t[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(_,{files:F,hidePreview:!0,renderArticle:s=>n.jsx($,{components:{code:s}})}),t[0]=e):e=t[0],e}export{L as default};
