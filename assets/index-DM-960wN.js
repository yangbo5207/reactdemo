import{j as e}from"./index-BxXbnW9e.js";import{A as l}from"./index-LK1iCBIb.js";import"./index-BEsnAH_r.js";import"./activecode-BfSkJlGQ.js";import"./index-DMQVh9lL.js";import"./Preview-Cfw1m546.js";const s=`function Layou2t() {
  const $ = _c(3);
...
`,e.jsxs(n.p,{children:["引入成功之后，我们可以在开发者工具中的 ",e.jsx(n.code,{children:"Sources"})," 面板的 ",e.jsx(n.code,{children:"Page"})," 目录中查看编译之后的代码，长得跟右侧代码差不多就表示编译成功了。"]})]})}function i(r={}){const{wrapper:n}=r.components||{};return n?e.jsx(n,{...r,children:e.jsx(c,{...r})}):c(r)}const t={"App.js":s};function j(){return e.jsx(l,{files:t,hidePreview:!0,renderArticle:r=>e.jsx(i,{components:{code:r}})})}export{j as default};
