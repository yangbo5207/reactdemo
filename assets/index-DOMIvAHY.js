import{c as i,a as v,j as n,r as S}from"./index-vB-mHLnv.js";import{B as A}from"./index-BmRxIqvy.js";import{C as _}from"./Cardruntime-DFtXWoxO.js";import{A as T}from"./index-CLBIbT-Y.js";import"./index-D8xVh8ID.js";import"./atom-one-light-Bb5l2Lva.js";import"./Preview-CBazhn3Q.js";const F=`import { useState, useEffect, useRef } from 'react'
...
`,n.jsx(e.p,{children:"并且 React Compiler 上手成本低，理解起来也不难，未来肯定会快速被大量开发者所接受。作为开发者我们只需要放心使用即可。"})]})}function X(r={}){const{wrapper:e}=r.components||{};return e?n.jsx(e,{...r,children:n.jsx(w,{...r})}):w(r)}const z={"App.js":F,"Panel1.jsx":E,"Panel2.jsx":M,"Panel3.jsx":B,"Panel4.jsx":D,"Button.jsx":{code:A,hidden:!0}};function ne(){const r=i.c(1);let e;return r[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(T,{files:z,renderArticle:l=>n.jsx(X,{components:{code:l}})}),r[0]=e):e=r[0],e}export{ne as default};
