import{c as u,j as s,r as m}from"./index-WxVCoI3R.js";import{C as N}from"./Cardruntime-CkAYSVvf.js";import{A as j}from"./index-z4EEj1-x.js";import"./activecode-B_nYYbD8.js";import"./index-DMQVh9lL.js";import"./Preview-B0JUZwug.js";import"./atom-one-light-CeVHWIu6.js";const y=`import {use, useState, Suspense} from 'react'
...
`,s.jsx(e.p,{children:"完整的代码和案例演示看右侧区域。"})]})}function C(n={}){const{wrapper:e}=n.components||{};return e?s.jsx(e,{...n,children:s.jsx(x,{...n})}):x(n)}const E={"App.js":y,"api.js":S,"List.jsx":w,"Skeleton.jsx":_};function X(){const n=u.c(1);let e;return n[0]===Symbol.for("react.memo_cache_sentinel")?(e=s.jsx(j,{files:E,renderArticle:i=>s.jsx(C,{components:{code:i}})}),n[0]=e):e=n[0],e}export{X as default};
