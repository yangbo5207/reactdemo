...
`})}),`
`,n.jsx(e.p,{children:"运行项目，查看开发者工具的 Sources 面板中的 Page 目录，我们发现 App.jsx 已经被编译成了右侧代码的样子。搞定。"})]})}function l(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(r,{...t})}):r(t)}const p={"App.js":c,原代码:a};function g(){const t=s.c(1);let e;return t[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(i,{files:p,hidePreview:!0,renderArticle:o=>n.jsx(l,{components:{code:o}})}),t[0]=e):e=t[0],e}export{g as default};
