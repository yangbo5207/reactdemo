import{j as e}from"./index-BxXbnW9e.js";import{C as a}from"./Cardruntime-DF2YgfxL.js";import{A as r}from"./index-B1rMsFzY.js";import"./activecode-BfSkJlGQ.js";function c(){return e.jsxs("form",{id:"form",method:"get",className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center",children:[e.jsx("label",{className:"w-[100px]",children:"First name: "}),e.jsx("input",{type:"text",defaultValue:"Jake",name:"fname"})]}),e.jsxs("div",{className:"flex items-center",children:[e.jsx("label",{className:"w-[100px]",children:"Last name: "}),e.jsx("input",{type:"text",defaultValue:"Ma",name:"lname"})]}),e.jsx("div",{className:"flex justify-end",children:e.jsx("button",{type:"submit",children:"提交"})})]})}function s(t){const n={blockquote:"blockquote",code:"code",h3:"h3",hr:"hr",p:"p",pre:"pre",strong:"strong",...t.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"在 html 的基础知识中，表单是很重要的一个环节"}),"，但是由于前端框架的盛行，原生表单开发方式相关的知识被部分前端框架所遗忘，很多人对 form action，formdata 很陌生。因此，当看到有消息称 React 19 支持了 form action 之后，许多前端感觉有点懵。这是啥？"]}),`
...
`})}),`
`,e.jsx(a,{reload:!0,children:e.jsx(c,{})}),`
...
`,e.jsx(n.p,{children:"了解了这些html form 元素中的基础知识之后，我们下一章再来详细的学习一下 FormData 的基础知识。"})]})}function o(t={}){const{wrapper:n}=t.components||{};return n?e.jsx(n,{...t,children:e.jsx(s,{...t})}):s(t)}function x(){return e.jsx(r,{renderArticle:t=>e.jsx(o,{components:{code:t}})})}export{x as default};
