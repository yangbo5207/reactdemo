import{c as p,j as t,r as m}from"./index-CChRFWmF.js";import{I as k,S as C,a as w}from"./index-CXet4OQj.js";import{C as h}from"./Cardruntime-DUSy2C1S.js";import{A as y}from"./index-CJl_FuZi.js";import"./index-BgxcxkDL.js";import"./atom-one-light-CiE-g8ab.js";import"./Preview-DUFWuue_.js";const D=`import {useState, Suspense, useDeferredValue} from 'react'
...
`,t.jsx(e.p,{children:"但是，等你彻底掌握它之后，你就会发现 React 19 在异步交互上真的太优雅了。这样的开发体验，是依赖 useEffect 完全比不了的。"})]})}function T(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(v,{...n})}):v(n)}const B={"App.js":D,"api.js":E,"List.jsx":L,"Input.jsx":$,"Skeleton.jsx":I,"Spin.jsx":{code:C,hidden:!0},"index.css":{code:w,hidden:!0}};function Q(){const n=p.c(1);let e;return n[0]===Symbol.for("react.memo_cache_sentinel")?(e=t.jsx(y,{files:B,renderArticle:r=>t.jsx(T,{components:{code:r}})}),n[0]=e):e=n[0],e}export{Q as default};
