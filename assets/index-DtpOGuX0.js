import{c as x,j as n,t as j,a as w,r as f}from"./index-CChRFWmF.js";import{C as N}from"./Cardruntime-DUSy2C1S.js";import{A as S}from"./index-CJl_FuZi.js";import"./index-BgxcxkDL.js";import"./atom-one-light-CiE-g8ab.js";import"./Preview-DUFWuue_.js";const k=`import {use, useState, Suspense, useEffect} from 'react'
...
`,T=s=>{const e=x.c(16);let t;e[0]!==s.message?(t=unescape(s.message.replace(/\\u/gi,"%u")),e[0]=s.message,e[1]=t):t=e[1];const i=t,r=s.username||"";let a;e[2]!==r?(a=unescape(r.replace(/\\u/gi,"%u")),e[2]=r,e[3]=a):a=e[3];const l=a,c=`https://api.dicebear.com/7.x/miniavs/svg?seed=${s.index||0}`;let o;e[4]!==c?(o=n.jsx("img",{className:"w-10",src:c,alt:""}),e[4]=c,e[5]=o):o=e[5];const p=l||"no name";let u;e[6]!==p?(u=n.jsx("div",{children:p}),e[6]=p,e[7]=u):u=e[7];let m;e[8]!==i?(m=n.jsx("div",{className:"text-sm mt-1 text-gray-600",children:i}),e[8]=i,e[9]=m):m=e[9];let h;e[10]!==u||e[11]!==m?(h=n.jsxs("div",{className:"flex-1 ml-3",children:[u,m]}),e[10]=u,e[11]=m,e[12]=h):h=e[12];let g;return e[13]!==o||e[14]!==h?(g=n.jsxs("div",{className:"flex border border-blue-100 p-4 rounded-md my-4 items-start",children:[o,h]}),e[13]=o,e[14]=h,e[15]=g):g=e[15],g};function B(s){const e=x.c(3);let t;e[0]===Symbol.for("react.memo_cache_sentinel")?(t=n.jsx("div",{className:"rounded-full bg-slate-200 h-10 w-10"}),e[0]=t):t=e[0];let i;e[1]===Symbol.for("react.memo_cache_sentinel")?(i=n.jsx("div",{className:"h-2 bg-slate-200 rounded"}),e[1]=i):i=e[1];let r;return e[2]===Symbol.for("react.memo_cache_sentinel")?(r=n.jsx("div",{className:"border border-blue-100 shadow rounded-md p-4 w-full",children:n.jsxs("div",{className:"animate-pulse flex space-x-4",children:[t,n.jsxs("div",{className:"flex-1 space-y-6 py-1",children:[i,n.jsxs("div",{className:"space-y-3",children:[n.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-2"}),n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-1"})]}),n.jsx("div",{className:"h-2 bg-slate-200 rounded"})]})]})]})}),e[2]=r):r=e[2],r}document.documentElement.style.fontSize="14px";function E(s){const e=x.c(24);let t,i,r,a,l,d,c,o;e[0]!==s?({className:c,primary:t,danger:i,sm:l,lg:d,signal:a,success:r,...o}=s,e[0]=s,e[1]=t,e[2]=i,e[3]=r,e[4]=a,e[5]=l,e[6]=d,e[7]=c,e[8]=o):(t=e[1],i=e[2],r=e[3],a=e[4],l=e[5],d=e[6],c=e[7],o=e[8]);let p;e[9]!==t||e[10]!==i||e[11]!==r||e[12]!==a||e[13]!==l||e[14]!==d||e[15]!==c?(p=j(w("rounded-md border border-transparent font-medium cursor-pointer transition relative","bg-gray-100 hover:bg-gray-200","text-xs py-2 px-4",{"bg-blue-500 text-white hover:bg-blue-600":t,"bg-red-500 text-white hover:bg-red-600":i,"bg-green-500 text-white hover:bg-green-600":r,"text-sky-500 bg-white border border-sky-300 hover:bg-sky-50":a,"text-xs py-1.5 px-3":l,"text-lg py-2 px-6":d},c)),e[9]=t,e[10]=i,e[11]=r,e[12]=a,e[13]=l,e[14]=d,e[15]=c,e[16]=p):p=e[16];const u=p;let m;e[17]!==a?(m=a&&n.jsxs("span",{className:"absolute flex h-3 w-3 right-[-5px] top-[-5px]",children:[n.jsx("span",{className:"animate-ping absolute inline-flex h-full w-full rounded-full bg-sky-400 opacity-75"}),n.jsx("span",{className:"relative inline-flex rounded-full h-3 w-3 bg-sky-500"})]}),e[17]=a,e[18]=m):m=e[18];let h;return e[19]!==u||e[20]!==o||e[21]!==s.children||e[22]!==m?(h=n.jsxs("button",{className:u,...o,children:[s.children,m]}),e[19]=u,e[20]=o,e[21]=s.children,e[22]=m,e[23]=h):h=e[23],h}const A=["React lets you build user interfaces out of individual pieces called components. Create your own React components like Thumbnail, LikeButton, and Video. Then combine them into entire screens, pages, and apps.","Whether you work on your own or with thousands of other developers, using React feels the same.","React components are JavaScript functions. Want to show some content conditionally? Use an if statement. Displaying a list? Try array map(). Learning React is learning programming.","This markup syntax is called JSX. It is a JavaScript syntax extension popularized by React. ","You don’t have to build your whole page in React. Add React to your existing HTML page, and render interactive React components anywhere on it."];var b=new Headers;b.append("User-Agent","Apifox/1.0.0 (https://apifox.com)");var D={method:"GET",headers:b,redirect:"follow",data:"hex"};const C="https://echo.apifox.com/delay/1",v=async()=>{await fetch(C,D);const s=Math.floor(Math.random()*10)%5;return{value:A[s],id:$()}};function $(){for(var s=[],e="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ",t=0;t<16;t++)s[t]=e.substr(Math.floor(Math.random()*16),1);return s[8]="-",s.join("")}function H(){const s=x.c(13);let e;s[0]===Symbol.for("react.memo_cache_sentinel")?(e=[],s[0]=e):e=s[0];const[t,i]=f.useState(e);let r;s[1]!==t?(r=()=>{i([...t,{type:"loading"}]),v().then(u=>{i([...t,u])})},s[1]=t,s[2]=r):r=s[2];let a;s[3]===Symbol.for("react.memo_cache_sentinel")?(a=[],s[3]=a):a=s[3],f.useEffect(r,a);let l;s[4]!==t?(l=function(){i([...t,{type:"loading"}]),v().then(m=>{i([...t,m])})},s[4]=t,s[5]=l):l=s[5];const d=l;let c;s[6]!==d?(c=n.jsx("div",{className:"text-right mb-4",children:n.jsx(E,{onClick:d,children:"新增数据"})}),s[6]=d,s[7]=c):c=s[7];let o;s[8]!==t?(o=n.jsx(J,{list:t}),s[8]=t,s[9]=o):o=s[9];let p;return s[10]!==c||s[11]!==o?(p=n.jsxs(n.Fragment,{children:[c,o]}),s[10]=c,s[11]=o,s[12]=p):p=s[12],p}function J(s){const e=x.c(5),t=s.list;let i;if(e[0]!==t){let a;e[2]===Symbol.for("react.memo_cache_sentinel")?(a=(l,d)=>l.type==="loading"?n.jsx(B,{},`hello ${d}`):n.jsx(T,{index:d,username:l.id,message:l.value},`h${d}`),e[2]=a):a=e[2],i=t.map(a),e[0]=t,e[1]=i}else i=e[1];let r;return e[3]!==i?(r=n.jsx(n.Fragment,{children:i}),e[3]=i,e[4]=r):r=e[4],r}function y(s){const e={code:"code",em:"em",h2:"h2",p:"p",pre:"pre",strong:"strong",...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.p,{children:"这一章我们要学习的是一个新增加载项到列表的案例。首先我们会通过接口获取到一条数据，然后将该数据渲染到列表中。你可以先通过右侧预览查看最终演示效果。"}),`
...
`,n.jsx(e.p,{children:"希望大家能够通过这个案例，进一步感受到新的开发思维的强大之处。"})]})}function O(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(y,{...s})}):y(s)}const P={"App.js":k,"api.js":_,"Userinfo.jsx":R,"Button.jsx":M,"Skeleton.jsx":U,"/public/index.html":L};function q(){const s=x.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(S,{files:P,renderArticle:t=>n.jsx(O,{components:{code:t}})}),s[0]=e):e=s[0],e}export{q as default};
