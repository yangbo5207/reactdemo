import{j as n,c as r}from"./index-vB-mHLnv.js";import{A as a}from"./index-CLBIbT-Y.js";import"./index-D8xVh8ID.js";import"./atom-one-light-Bb5l2Lva.js";import"./Preview-CBazhn3Q.js";const o=`import { useState, Suspense } from 'react';
...
`]})]})}function u(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(t,{...s})}):t(s)}const x={"App.js":o,"api.js":c,"List.jsx":m,"Button.jsx":l,"Skeleton.jsx":p,"/public/index.html":d};function b(){const s=r.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(a,{files:x,renderArticle:i=>n.jsx(u,{components:{code:i}})}),s[0]=e):e=s[0],e}export{b as default};
