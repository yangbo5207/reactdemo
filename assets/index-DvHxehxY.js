import{c as d,r as u,j as e,M as p,D as h}from"./index-WxVCoI3R.js";import{C as c}from"./Cardruntime-CkAYSVvf.js";import{A as x}from"./index-z4EEj1-x.js";import"./activecode-B_nYYbD8.js";import"./index-DMQVh9lL.js";import"./Preview-B0JUZwug.js";import"./atom-one-light-CeVHWIu6.js";const j=`import { useRef } from 'react'
...
`,e.jsxs(n.p,{children:["最终的代码请看右侧案例中的 ",e.jsx(n.code,{children:"Dialog.jsx"})]})]})}function v(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(f,{...s})}):f(s)}const b={"App.js":j,"Dialog.jsx":w,"Modal.jsx":g};function k(){const s=d.c(1);let n;return s[0]===Symbol.for("react.memo_cache_sentinel")?(n=e.jsx(x,{files:b,hidePreview:!0,renderArticle:o=>e.jsx(v,{components:{code:o}})}),s[0]=n):n=s[0],n}export{k as default};
