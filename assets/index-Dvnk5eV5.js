import{c as d,j as n,r as m}from"./index-B75hTygv.js";import{C as f}from"./Cardruntime-tmsTwtfU.js";import{A as j}from"./index-Qgvc3jsz.js";import"./Preview-Bj6s79pd.js";import"./atom-one-light-BQMUJUMb.js";const g=`import {useState, Suspense} from 'react'
...
`,_=`export default function Input(props) {
  const {...other} = props
  return (
...
`;document.documentElement.style.fontSize="14px";function y(s){const e=d.c(3);let r;e[0]===Symbol.for("react.memo_cache_sentinel")?(r=n.jsx("div",{className:"rounded-full bg-slate-200 h-10 w-10"}),e[0]=r):r=e[0];let l;e[1]===Symbol.for("react.memo_cache_sentinel")?(l=n.jsx("div",{className:"h-2 bg-slate-200 rounded"}),e[1]=l):l=e[1];let t;return e[2]===Symbol.for("react.memo_cache_sentinel")?(t=n.jsx("div",{className:"border border-blue-100 shadow rounded-md p-4 w-full mt-4",children:n.jsxs("div",{className:"animate-pulse flex space-x-4",children:[r,n.jsxs("div",{className:"flex-1 space-y-6 py-1",children:[l,n.jsxs("div",{className:"space-y-3",children:[n.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-2"}),n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-1"})]}),n.jsx("div",{className:"h-2 bg-slate-200 rounded"})]})]})]})}),e[2]=t):t=e[2],t}const p=async s=>(await fetch(`https://randomuser.me/api/?results=${s}&inc=name,gender,email,nat,picture&noinfo`)).json();function C(s){const e=d.c(5),{promise:r}=s,{results:l}=m.use(r);console.log("我会执行几次呢");let t;if(e[0]!==l){let o;e[2]===Symbol.for("react.memo_cache_sentinel")?(o=(c,a)=>n.jsxs("div",{className:"flex border p-4 items-center my-4 rounded-md",children:[n.jsx("img",{className:"w-12 h-12 rounded-full",src:c.picture.large,alt:""}),n.jsxs("div",{className:"flex-1 ml-4",children:[n.jsx("div",{className:"font-bold",children:c.name.last}),n.jsx("div",{className:"text-gray-400 mt-1 text-sm line-clamp-1",children:"react 19 re, a design language for background applications"})]})]},`h${a}`),e[2]=o):o=e[2],t=l.map(o),e[0]=l,e[1]=t}else t=e[1];let i;return e[3]!==t?(i=n.jsx("div",{children:t}),e[3]=t,e[4]=i):i=e[4],i}function L(s){const e=d.c(6);let r;e[0]!==s?({...r}=s,e[0]=s,e[1]=r):r=e[1];let l;e[2]===Symbol.for("react.memo_cache_sentinel")?(l=n.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",strokeWidth:1.5,stroke:"currentColor",className:"size-5",children:n.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",d:"m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z"})}),e[2]=l):l=e[2];let t;e[3]===Symbol.for("react.memo_cache_sentinel")?(t={outline:"none"},e[3]=t):t=e[3];let i;return e[4]!==r?(i=n.jsxs("div",{className:"flex items-center border px-2 rounded-md text-gray-500",children:[l,n.jsx("input",{className:"flex-1 !border-none p-2",style:t,type:"text",...r})]}),e[4]=r,e[5]=i):i=e[5],i}function w(){const s=d.c(6);let e;s[0]===Symbol.for("react.memo_cache_sentinel")?(e=()=>p(5),s[0]=e):e=s[0];const[r,l]=m.useState(e);let t;s[1]===Symbol.for("react.memo_cache_sentinel")?(t=function(u){const x=u.target.value.length%10;l(p(x))},s[1]=t):t=s[1];const i=t;let o;s[2]===Symbol.for("react.memo_cache_sentinel")?(o=n.jsx(L,{onChange:i,placeholder:"Enter something"}),s[2]=o):o=s[2];let c;s[3]===Symbol.for("react.memo_cache_sentinel")?(c=n.jsx(y,{}),s[3]=c):c=s[3];let a;return s[4]!==r?(a=n.jsxs("div",{children:[o,n.jsx(m.Suspense,{fallback:c,children:n.jsx(C,{promise:r})})]}),s[4]=r,s[5]=a):a=s[5],a}function h(s){const e={code:"code",em:"em",h2:"h2",p:"p",pre:"pre",strong:"strong",...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(f,{children:n.jsx(w,{})}),`
...
`})}),`
`,n.jsx(e.p,{children:"其他的逻辑基本保持不变，完整代码和演示效果请在右侧区域查看。请务必结合调试工具中的网络请求一起观察演示效果。"})]})}function k(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(h,{...s})}):h(s)}const A={"App.js":g,"api.js":v,"List.jsx":S,"Input.jsx":_,"Skeleton.jsx":b,"/public/index.html":N};function z(){const s=d.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(j,{files:A,renderArticle:r=>n.jsx(k,{components:{code:r}})}),s[0]=e):e=s[0],e}export{z as default};
