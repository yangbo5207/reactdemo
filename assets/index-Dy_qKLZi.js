import{c as d,j as n,r as m}from"./index-CChRFWmF.js";import{C as f}from"./Cardruntime-DUSy2C1S.js";import{A as j}from"./index-CJl_FuZi.js";import"./index-BgxcxkDL.js";import"./atom-one-light-CiE-g8ab.js";import"./Preview-DUFWuue_.js";const g=`import {useState, Suspense} from 'react'
...
`})}),`
`,n.jsx(e.p,{children:"其他的逻辑基本保持不变，完整代码和演示效果请在右侧区域查看。请务必结合调试工具中的网络请求一起观察演示效果。"})]})}function w(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(u,{...s})}):u(s)}const k={"App.js":g,"api.js":v,"List.jsx":N,"Input.jsx":S,"Skeleton.jsx":b};function z(){const s=d.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(j,{files:k,renderArticle:r=>n.jsx(w,{components:{code:r}})}),s[0]=e):e=s[0],e}export{z as default};
