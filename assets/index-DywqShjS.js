import{c as d,r as m,j as t}from"./index-vB-mHLnv.js";import{B as f}from"./index-BmRxIqvy.js";import{C as j}from"./Cardruntime-DFtXWoxO.js";import{A as x}from"./index-CLBIbT-Y.js";import"./index-D8xVh8ID.js";import"./atom-one-light-Bb5l2Lva.js";import"./Preview-CBazhn3Q.js";const p=`import {useState} from 'react'
...
`]}),`
`,t.jsx(e.p,{children:"当然，这里多执行的逻辑也并不是很多，我们也可以选择无视。"})]})}function v(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(u,{...n})}):u(n)}const C={"App.js":p,原代码:h,"useCache.js":{code:_,hidden:!0},"Button.jsx":{code:f,hidden:!0}};function N(){const n=d.c(1);let e;return n[0]===Symbol.for("react.memo_cache_sentinel")?(e=t.jsx(x,{files:C,renderArticle:l=>t.jsx(v,{components:{code:l}})}),n[0]=e):e=n[0],e}export{N as default};
