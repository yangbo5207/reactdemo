import{c as u,j as n,r as m}from"./index-vB-mHLnv.js";import{C as g}from"./Cardruntime-DFtXWoxO.js";import{A as v}from"./index-CLBIbT-Y.js";import"./index-D8xVh8ID.js";import"./atom-one-light-Bb5l2Lva.js";import"./Preview-CBazhn3Q.js";const j=`import {useState, Suspense, useCallback} from 'react'
...
`;document.documentElement.style.fontSize="14px";function w(s){const e=u.c(3);let a;e[0]===Symbol.for("react.memo_cache_sentinel")?(a=n.jsx("div",{className:"rounded-full bg-slate-200 h-10 w-10"}),e[0]=a):a=e[0];let r;e[1]===Symbol.for("react.memo_cache_sentinel")?(r=n.jsx("div",{className:"h-2 bg-slate-200 rounded"}),e[1]=r):r=e[1];let t;return e[2]===Symbol.for("react.memo_cache_sentinel")?(t=n.jsx("div",{className:"border border-blue-100 shadow rounded-md p-4 w-full mt-4",children:n.jsxs("div",{className:"animate-pulse flex space-x-4",children:[a,n.jsxs("div",{className:"flex-1 space-y-6 py-1",children:[r,n.jsxs("div",{className:"space-y-3",children:[n.jsxs("div",{className:"grid grid-cols-3 gap-4",children:[n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-2"}),n.jsx("div",{className:"h-2 bg-slate-200 rounded col-span-1"})]}),n.jsx("div",{className:"h-2 bg-slate-200 rounded"})]})]})]})}),e[2]=t):t=e[2],t}const f=s=>{let e=new AbortController,a=e.signal;const r=new Promise(t=>{fetch(`https://randomuser.me/api/?results=${s}&inc=name,gender,email,nat,picture&noinfo`,{signal:a}).then(o=>{localStorage.setItem("modal","xxx"),t(o.json())}).catch(()=>{console.log("接口成功取消！")})});return r.cancel=()=>{e&&e.abort()},r};function h(...s){return s.filter(Boolean).join(" ")}function _(s){const e=u.c(7),{tabs:a,onSwitch:r}=s;let t;if(e[0]!==r||e[1]!==a){let c;e[3]!==r?(c=(l,i)=>n.jsxs("a",{href:"#",onClick:()=>r(i),className:h(l.current?"border-indigo-500 text-indigo-600":"border-transparent text-gray-500 hover:border-gray-200 hover:text-gray-700","flex whitespace-nowrap border-b-2 px-1 py-4 text-sm font-medium"),"aria-current":l.current?"page":void 0,children:[l.name,l.count?n.jsx("span",{className:h(l.current?"bg-indigo-100 text-indigo-600":"bg-gray-100 text-gray-900","ml-3 rounded-full px-2.5 py-0.5 text-xs font-medium inline-block"),children:l.count}):null]},l.name),e[3]=r,e[4]=c):c=e[4],t=a.map(c),e[0]=r,e[1]=a,e[2]=t}else t=e[2];let o;return e[5]!==t?(o=n.jsx("div",{children:n.jsx("div",{className:"border-b border-gray-200",children:n.jsx("nav",{className:"-mb-px flex space-x-8","aria-label":"Tabs",children:t})})}),e[5]=t,e[6]=o):o=e[6],o}function T(s){const e=u.c(10),{promise:a,onComplete:r}=s,{results:t}=m.use(a);let o;e[0]!==r||e[1]!==t.length?(o=()=>{r&&r(t.length)},e[0]=r,e[1]=t.length,e[2]=o):o=e[2];let c;e[3]!==t.length?(c=[t.length],e[3]=t.length,e[4]=c):c=e[4],m.useEffect(o,c);let l;if(e[5]!==t){let d;e[7]===Symbol.for("react.memo_cache_sentinel")?(d=(p,b)=>n.jsxs("div",{className:"flex border p-4 items-center my-4 rounded-md",children:[n.jsx("img",{className:"w-12 h-12 rounded-full",src:p.picture.large,alt:""}),n.jsxs("div",{className:"flex-1 ml-4",children:[n.jsx("div",{className:"font-bold",children:p.name.last}),n.jsx("div",{className:"text-gray-400 mt-1 text-sm line-clamp-1",children:"react 19 re, a design language for background applications"})]})]},`h${b}`),e[7]=d):d=e[7],l=t.map(d),e[5]=t,e[6]=l}else l=e[6];let i;return e[8]!==l?(i=n.jsx("div",{children:l}),e[8]=l,e[9]=i):i=e[9],i}const k=[{name:"Applied",href:"#",count:0,current:!0},{name:"Phone Screening",href:"#",count:0,current:!1},{name:"Interview",href:"#",count:0,current:!1},{name:"Offer",href:"#",count:0,current:!1},{name:"Disqualified",href:"#",count:0,current:!1}];function L(){const[s,e]=m.useState(0),[a,r]=m.useState(()=>f(5)),[t,o]=m.useState(k);function c(i){t[s].current=!1,t[i].current=!0,e(i),o([...t]),a.cancel();const d=Math.floor(Math.random()*10);r(f(d))}function l(i){t[s].count=i,o([...t])}return n.jsxs("div",{children:[n.jsx(_,{tabs:t,onSwitch:c}),n.jsx(m.Suspense,{fallback:n.jsx(w,{}),children:n.jsx(T,{promise:a,onComplete:l})})]})}function x(s){const e={code:"code",p:"p",pre:"pre",...s.components};return n.jsxs(n.Fragment,{children:[n.jsx(g,{reload:!0,children:n.jsx(L,{})}),`
...
`})}),`
`,n.jsx(e.p,{children:"完整代码与案例演示查看右侧区域。"})]})}function E(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(x,{...s})}):x(s)}const A={"App.js":j,"api.js":N,"List.jsx":y,"Tabs.jsx":C,"Skeleton.jsx":S};function z(){const s=u.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(v,{files:A,renderArticle:a=>n.jsx(E,{components:{code:a}})}),s[0]=e):e=s[0],e}export{z as default};
