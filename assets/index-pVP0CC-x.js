import{r as s,j as n,b as l}from"./index-BxXbnW9e.js";import{C as i}from"./Cardruntime-DF2YgfxL.js";import{A as o}from"./index-LK1iCBIb.js";import"./index-BEsnAH_r.js";import"./activecode-BfSkJlGQ.js";import"./index-DMQVh9lL.js";import"./Preview-Cfw1m546.js";const d=`import {useState} from 'react'
...
`;function j(){const[c,e]=s.useState(0);function r(){e(c+1)}return n.jsxs("div",{children:[n.jsx("div",{children:"A Base Case"}),n.jsxs("div",{className:"flex items-center justify-between",children:[n.jsxs("div",{children:["currnt count is: ",c]}),n.jsx("button",{onClick:r,children:"Increment"})]})]})}function t(c){const e={blockquote:"blockquote",code:"code",em:"em",h2:"h2",img:"img",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...c.components};return n.jsxs(n.Fragment,{children:[n.jsx(e.h2,{children:n.jsx(e.em,{children:"1"})}),`
...
`,n.jsx(i,{children:n.jsx(j,{})}),`
`,n.jsx(e.pre,{children:n.jsx(e.code,{className:"language-javascript",children:`function Counter() {
  const $ = _c(10);
...
`,n.jsx(e.p,{children:"这个案例会非常的复杂，经验稍微欠缺一点的前端开发可能都实现不了。我们先来看一下我想要实现的演示效果。"}),`
`,n.jsx(e.p,{children:n.jsx(e.img,{src:"https://files.mdnice.com/user/3925/551a8f32-866d-4155-881a-5e3bce0d38ff.gif",alt:""})}),`
...
`]}),`
`,n.jsx(e.p,{children:"具体的完整实现我们会在后续的直播中跟大家分享。大家可以加我好友然后进 React19 讨论群，React19 相关的直播消息会第一时间在群内公布。"}),`
...
`,n.jsx(e.p,{children:n.jsx(e.img,{src:"https://files.mdnice.com/user/3925/c7215fd7-c92d-4aaa-8433-8b93be700fa7.png",alt:""})}),`
`,n.jsx(e.p,{children:"为了对比具体的效果，我们可以判断一下依赖收集的时间成本。"}),`
`,n.jsx(e.p,{children:"首先是使用数组来收集依赖。依然是 100 万次，具体执行结果如下。耗时 8 毫秒。"}),`
`,n.jsx(e.p,{children:n.jsx(e.img,{src:"https://files.mdnice.com/user/3925/8c8d4d13-dc2f-4855-a709-36811a895ba4.png",alt:""})}),`
`,n.jsx(e.p,{children:"使用 Map 来收集依赖。100 万次依赖收集耗时 54 ms。"}),`
`,n.jsx(e.p,{children:n.jsx(e.img,{src:"https://files.mdnice.com/user/3925/7d78bae3-15cd-48cb-aeda-46250e404ddf.png",alt:""})}),`
`,n.jsx(e.p,{children:"使用 WeakMap 来收集依赖，那就更慢了。100万次依赖收集耗时 200 毫秒。"}),`
`,n.jsxs(e.blockquote,{children:[`
`,n.jsx(e.p,{children:"WeakMap 的 key 不能是一个 number 类型"}),`
`]}),`
`,n.jsx(e.p,{children:n.jsx(e.img,{src:"https://files.mdnice.com/user/3925/f140d968-30ef-42c9-961a-f8fcb8e1cbf0.png",alt:""})}),`
...
`,n.jsx(e.p,{children:"并且 React Compiler 上手成本低，理解起来也不难，未来肯定会快速被开发者所接受。作为开发者我们只需要耐心等待整个生态的跟进，目前从 npm 下载数据上来看，整个生态适配 React19 的积极性非常高。因此距离能成熟使用的时间肯定是不会太长。"}),`
`,n.jsxs(e.blockquote,{children:[`
`,n.jsx(e.p,{children:"顶尖前端都在关注我，就差你啦，右下角"}),`
`,n.jsx(e.p,{children:"成为 React 高手，推荐阅读 React 哲学"}),`
`]})]})}function u(c={}){const{wrapper:e}=c.components||{};return e?n.jsx(e,{...c,children:n.jsx(t,{...c})}):t(c)}const p={"App.js":d,原代码:a,"useCache.js":{code:x,hidden:!0},"Button.jsx":{code:l,hidden:!0}};function v(){return n.jsx(o,{files:p,renderArticle:c=>n.jsx(u,{components:{code:c}})})}export{v as default};
