import{c as b,j as n,r as j}from"./index-WxVCoI3R.js";import{C as S}from"./Cardruntime-CkAYSVvf.js";import{A as N}from"./index-z4EEj1-x.js";import"./activecode-B_nYYbD8.js";import"./index-DMQVh9lL.js";import"./Preview-B0JUZwug.js";import"./atom-one-light-CeVHWIu6.js";const y=`import {useState, Suspense} from 'react'
...
`})}),`
`,n.jsx(e.p,{children:"这里我们依然需要取消上一次请求是因为可能有的使用者会连续快速切换，我们可以通过取消为完成请求的方式让页面响应变得合理与流畅。完整的案例请看右侧区域。"})]})}function A(t={}){const{wrapper:e}=t.components||{};return e?n.jsx(e,{...t,children:n.jsx(x,{...t})}):x(t)}const E={"App.js":y,"api.js":T,"List.jsx":C,"Tabs.jsx":k,"Skeleton.jsx":w};function U(){const t=b.c(1);let e;return t[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(N,{files:E,renderArticle:r=>n.jsx(A,{components:{code:r}})}),t[0]=e):e=t[0],e}export{U as default};
