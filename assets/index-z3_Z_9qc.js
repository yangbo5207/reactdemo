import{c as i,r as p,j as n}from"./index-oQiJtYgt.js";import{C as m}from"./Cardruntime-WygvHClN.js";import{A as u}from"./index-FLqTg1MW.js";import"./Preview-CBmvf_l4.js";import"./atom-one-light-EzjejzeC.js";const x=`import {Suspense, useState, useTransition} from 'react'
...
`,n.jsx(e.p,{children:"希望大家能够在这里获得全网最好的学习体验！Let's go."})]})}function M(s={}){const{wrapper:e}=s.components||{};return e?n.jsx(e,{...s,children:n.jsx(d,{...s})}):d(s)}const A={"App.js":x,"api.js":j,"Message.jsx":g,"Skeleton.jsx":f,"Button.jsx":b};function B(){const s=i.c(1);let e;return s[0]===Symbol.for("react.memo_cache_sentinel")?(e=n.jsx(u,{files:A,renderArticle:r=>n.jsx(M,{components:{code:r}})}),s[0]=e):e=s[0],e}export{B as default};
