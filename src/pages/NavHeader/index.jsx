  ...
  return (
    <header className='fixed z-50 top-0 flex justify-between border-b border-slate-200 min-w-[320px] bg-white bg-opacity-70 backdrop-blur-sm w-full'>
      ...
      <Modal ref={modal} onClose={() => modal.current.close()}>
        <header className='sticky top-0 flex justify-between border-b border-amber-50 bg-amber-50'>
          <div className='pl-6 h-16 flex items-center md:pl-10 transition-all'>
            <ActiveLink className='flex items-center' to='/'>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
                <path fillRule="evenodd" d="M12 1.5a.75.75 0 0 1 .75.75V4.5a.75.75 0 0 1-1.5 0V2.25A.75.75 0 0 1 12 1.5ZM5.636 4.136a.75.75 0 0 1 1.06 0l1.592 1.591a.75.75 0 0 1-1.061 1.06l-1.591-1.59a.75.75 0 0 1 0-1.061Zm12.728 0a.75.75 0 0 1 0 1.06l-1.591 1.592a.75.75 0 0 1-1.06-1.061l1.59-1.591a.75.75 0 0 1 1.061 0Zm-6.816 4.496a.75.75 0 0 1 .82.311l5.228 7.917a.75.75 0 0 1-.777 1.148l-2.097-.43 1.045 3.9a.75.75 0 0 1-1.45.388l-1.044-3.899-1.601 1.42a.75.75 0 0 1-1.247-.606l.569-9.47a.75.75 0 0 1 .554-.68ZM3 10.5a.75.75 0 0 1 .75-.75H6a.75.75 0 0 1 0 1.5H3.75A.75.75 0 0 1 3 10.5Zm14.25 0a.75.75 0 0 1 .75-.75h2.25a.75.75 0 0 1 0 1.5H18a.75.75 0 0 1-.75-.75Zm-8.962 3.712a.75.75 0 0 1 0 1.061l-1.591 1.591a.75.75 0 1 1-1.061-1.06l1.591-1.592a.75.75 0 0 1 1.06 0Z" clipRule="evenodd" />
          ...
          <div className='flex h-16 items-center pr-6 text-gray-500'>
            <div className='flex items-center text-gray-700' onClick={() => modal.current.show()}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
          ...
          <div key={item.path} className='flex items-center text-gray-700 bg-white px-8 py-5 transition hover:bg-amber-100'>
            <ActiveLink className='flex items-center justify-between w-full' to='/'>
              <div className='flex'>
                ...
                <div className='ml-2 text-sm'>{item.text}</div>
              </div>
        ...
        <div className='flex items-center text-red-500 bg-red-50 px-8 py-5 transition hover:text-red-700 hover:bg-red-200'>
          <ActiveLink className='flex items-center justify-between w-full' to='/'>
            <div className='flex'>
              ...
              <div className='ml-2 text-sm'>推荐：JavaScript 核心进阶</div>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
                <path fillRule="evenodd" d="M12.97 3.97a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 1 1-1.06-1.06l6.22-6.22H3a.75.75 0 0 1 0-1.5h16.19l-6.22-6.22a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
        ...
        <div className='flex items-center text-gray-700 bg-white px-8 py-5 transition hover:bg-amber-100'>
          <ActiveLink className='flex items-center justify-between w-full' to='/'>
            <div className='flex'>
              ...
              <div className='ml-2 text-sm'>交流群</div>
            </div>
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4">
                <path fillRule="evenodd" d="M12.97 3.97a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 0 1 0 1.06l-7.5 7.5a.75.75 0 1 1-1.06-1.06l6.22-6.22H3a.75.75 0 0 1 0-1.5h16.19l-6.22-6.22a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
        ...
        <div className='flex items-center text-gray-700 bg-white px-8 py-5 transition hover:bg-amber-100'>
          <ActiveLink className='flex items-center justify-between w-full' to='/'>
            <div className='flex'>
              ...
              <div className='ml-2 text-sm'>激活码</div>
          </div>
