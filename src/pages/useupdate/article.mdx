...
![](https://files.mdnice.com/user/3925/0c76c8ce-56b5-4e04-b28b-4e4f9be3c4f0.gif)
...
![](https://files.mdnice.com/user/3925/22e8ec33-ae77-49be-a9af-d6e95d4a00ca.gif)
...
![](https://files.mdnice.com/user/3925/195f08a9-af2e-4b85-a82b-313f4e9b08c4.png)

代码演示结果如下

![](https://files.mdnice.com/user/3925/510cee49-467f-47bb-ad7d-f540602b778c.gif)
...
![](https://files.mdnice.com/user/3925/a64efea9-9c16-46c4-9478-f9f07efb1ce4.gif)


**结论：**

很明显，`react 19` 的 hook 在底层发生了许多优化更新，我们可以不用非得把所有的 hook 都放在函数组件的最前面去执行了。
...
![](https://files.mdnice.com/user/3925/1410c565-e043-4e5d-b5a2-4c871d548a01.png)
...
console.log('foo', foo)
return (
  <button onClick={() => setCounter(counter + 1)}>counter ++ foo: {foo}</button>
)
```
...
![](https://files.mdnice.com/user/3925/2a0ec0c2-e5cd-4675-96e3-84c0281bc554.png)
...
![](https://files.mdnice.com/user/3925/f51f4543-ccc2-4116-a793-73f781fc1014.jpg)
